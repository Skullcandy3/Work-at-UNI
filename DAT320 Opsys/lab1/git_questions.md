...
5. If the remote repositories are set up as in the following segment, how would you pull changes from the `dat320-2025/assignments` repo into the `dat320-2025/student-labs` repo you are working in?

    ```console
    course-assignments  git@github.com:dat320-2025/assignments.git (fetch)
    course-assignments  git@github.com:dat320-2025/assignments.git (push)
    origin              git@github.com:dat320-2025/student-labs.git (fetch)
    origin              git@github.com:dat320-2025/student-labs.git (push)
    ```

    - [ ] a) `git pull dat320-2025/assignments.git dat320-2025/student-labs.git`
